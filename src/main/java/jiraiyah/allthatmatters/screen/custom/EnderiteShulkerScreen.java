...
public class EnderiteShulkerScreen extends HandledScreen<EnderiteShulkerScreenHandler>
{
    ...
    protected void drawBackground(DrawContext context, float delta, int mouseX, int mouseY)
    {
        ...
        context.drawTexture(selectedTexture,x + 4, y + 191, 1,231,0,10,78,256, Math.max(256, backgroundHeight));
        context.drawTexture(selectedTexture,x + 216, y + 191, 1,231,0,10,78,256, Math.max(256, backgroundHeight));
    }
